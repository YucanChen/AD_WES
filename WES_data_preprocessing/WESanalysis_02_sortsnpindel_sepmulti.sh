...
out_snp=~/burden_test/case/WES_highquality_hg38_sorted.snp.snpEff.vcf.gz
out_indel=~/burden_test/case/WES_highquality_hg38_sorted.indel.snpEff.vcf.gz
merged_variants=~/burden_test/case/WES_highquality_hg38_sorted.all.snpEff.vcf.gz
...
in_vcf=~/burden_test/case/WES_highquality_hg38_sorted.all.snpEff.vcf.gz
ref=~/gatk-4.1.0.0/bundle_hg38/Homo_sapiens_assembly38.fasta
out_vcf=~/burden_test/case/WES_highquality_hg38_sorted.all.norm.vcf.gz
